...
<meta content="width=device-width, initial-scale=1, maximum-scale=1, userModel-scalable=no" name="viewport">
<!-- Bootstrap 3.3.5 -->
    ...
    <nav class="navbar navbar-static-top">
        <div class="container">
            <div class="navbar-header">
                <a href="${request.contextPath}/" class="navbar-brand"><b>Code Generator</b></a>
            ...
            <div class="navbar-custom-menu">
                <ul class="nav navbar-nav">
                    <li class="dropdown userModel userModel-menu">
                        <a target="_blank" href="">文档</a>
...
<footer class="main-footer">
    <div class="container">
        Base on <b>XXL Code Generator</b> v0.0.2
        <div class="pull-right hidden-xs">
            <strong>Copyright &copy; 2018-${.now?string('yyyy')} &nbsp;
                <a href="https://www.xuxueli.com/" target="_blank" >cui</a>
