                    ...
                    <div class2="col-md-9" >
                        ...
                        <div class="box box-default">
                            <div class="box-header with-border">
                                ...
                                <button type="button" class="btn btn-default btn-xs pull-right" id="codeGenerate" >生成代码(单表)</button>
                                <button type="button" class="btn btn-default btn-xs pull-right" id="codeGenerateAll" >生成代码(多表)</button>
                                </div>
                            <div class="box-body">
  ...
  PRIMARY KEY (`user_id`)
                        ...
                        <div class="nav-tabs-custom">
                            ...
                            <ul class="nav nav-tabs pull-right">
                                ...
                                <li><a href="#mybatis" data-toggle="tab">Mapper.xml</a></li>
